# @taktikorg/voluptate-delectus

[![NPM version](https://img.shields.io/npm/v/@taktikorg/voluptate-delectus.svg?style=flat)](https://npmjs.org/package/@taktikorg/voluptate-delectus)
[![NPM downloads](https://img.shields.io/npm/dm/@taktikorg/voluptate-delectus.svg?style=flat)](https://npmjs.org/package/@taktikorg/voluptate-delectus)
![CI](https://github.com/taktikorg/voluptate-delectus/workflows/CI/badge.svg)
...
```shell
yarn add --dev @taktikorg/voluptate-delectus
```

Or

```shell
npm install --save-dev @taktikorg/voluptate-delectus
```
...
const eslintPluginEmberRecommended = require('@taktikorg/voluptate-delectus/configs/recommended');
...
💼 [Configurations](https://github.com/taktikorg/voluptate-delectus#-configurations) enabled in.\
✅ Set in the `recommended` [configuration](https://github.com/taktikorg/voluptate-delectus#-configurations).\
![gjs logo](/docs/svgs/gjs.svg) Set in the `recommended-gjs` [configuration](https://github.com/taktikorg/voluptate-delectus#-configurations).\
![gts logo](/docs/svgs/gts.svg) Set in the `recommended-gts` [configuration](https://github.com/taktikorg/voluptate-delectus#-configurations).\
...
If you have any suggestions, ideas, or problems, feel free to [create an issue](https://github.com/taktikorg/voluptate-delectus/issues/new), but first please make sure your question does not repeat [previous ones](https://github.com/taktikorg/voluptate-delectus/issues).

### Creating a New Rule

- [Create an issue](https://github.com/taktikorg/voluptate-delectus/issues/new) with a description of the proposed rule
- Create files for the [new rule](https://eslint.org/docs/developer-guide/working-with-rules):
  ...
  - `docs/rules/new-rule.md` (documentation, start from the template -- [raw](https://raw.githubusercontent.com/ember-cli/@taktikorg/voluptate-delectus/master/docs/rules/_TEMPLATE_.md), [rendered](docs/rules/_TEMPLATE_.md))
